<?php
	...
	add_action('admin_menu', 'Wbcr_FactoryPages447::actionAdminMenu');
	add_action('network_admin_menu', 'Wbcr_FactoryPages447::actionAdminMenu');
	...
	if( !class_exists('Wbcr_FactoryPages447') ) {
		 ...
		 * @since 1.0.0
		 */
		class Wbcr_FactoryPages447 {

			/**
			 * @var Wbcr_FactoryPages447_Page[]
			 */
			...
			public static function getPageUrl(Wbcr_Factory448_Plugin $plugin, $page_id, $args = array())
			{
				if( isset(self::$pages[$plugin->getPluginName()]) ) {
	...
	if( !function_exists('wbcr_factory_pages_447_get_page_id') ) {
		/**
		 *
		 * @param Wbcr_Factory448_Plugin $plugin
		 ...
		 * @return string
		 */
		function wbcr_factory_pages_447_get_page_id($plugin, $page_id)
		{
