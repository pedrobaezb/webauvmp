<?php
	...
	if( !class_exists('Wbcr_FactoryForms445_FormLayout') ) {

		/**
		 * The base class for all form layouts.
		 */
		abstract class Wbcr_FactoryForms445_FormLayout extends Wbcr_FactoryForms445_Holder {
			...
			public function __construct($options, $form)
			{
				...
				$this->addCssClass('factory-forms-445-' . $this->type);
				$this->addCssClass('factory-forms-445-' . $this->name);
			}
