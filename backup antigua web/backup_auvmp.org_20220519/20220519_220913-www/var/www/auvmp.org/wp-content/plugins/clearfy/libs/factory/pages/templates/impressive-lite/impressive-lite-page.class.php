...
if ( ! class_exists( 'Wbcr_FactoryPages447_ImpressiveLiteTemplate' ) ) {
	/**
	 * Class Wbcr_FactoryPages447_ImpressiveLiteTemplate
	 */
	abstract class Wbcr_FactoryPages447_ImpressiveLiteTemplate extends Wbcr_FactoryPages447_ImpressiveThemplate {
		...
		public function __construct( Wbcr_Factory448_Plugin $plugin ) {
			$this->menuIcon = FACTORY_PAGES_447_URL . '/templates/impressive-lite/assets/img/webcraftic-plugin-icon.png';
		...
		public function assets( $scripts, $styles ) {
			...
			$this->styles->add( FACTORY_PAGES_447_URL . '/templates/impressive-lite/assets/css/impressive-lite.page.template.css' );
		}
		...
		protected function showOptions() {
            ...
            <div id="WBCR" class="wrap">
                <div class="wbcr-factory-pages-447-impressive-lite-page-template factory-bootstrap-448 factory-fontawesome-000">
