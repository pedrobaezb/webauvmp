...
namespace WBCR\Factory_Freemius_136\Premium;

use WBCR\Factory_Freemius_136\Entities\License;
use WBCR\Factory_Freemius_136\Entities\Plugin;
use WBCR\Factory_Freemius_136\Entities\Site;
use WBCR\Factory_Freemius_136\Entities\User;
use WBCR\Factory_448\Premium\Provider as License_Provider;
use Wbcr_Factory448_Plugin;
use WBCR\Factory_Freemius_136\Api;
use WP_Error;
use Exception;
...
final class Provider extends License_Provider {
	...
	/**
	 * @var \WBCR\Factory_Freemius_136\Api
	 */
	private $site_api;
	...
	/**
	 * @return \WBCR\Factory_Freemius_136\Entities\License|null
	 * @throws Exception
	 */
	 ...
	 * @param bool $flush
	 *
	 * @return \WBCR\Factory_Freemius_136\Api
	 * @throws Exception
	 */
