<?php
	...
	if( !class_exists('Wbcr_FactoryForms445_Bootstrap3FormLayout') ) {
		/**
		 * A form layout based on Twitter Bootstrap 3
		 */
		class Wbcr_FactoryForms445_Bootstrap3FormLayout extends Wbcr_FactoryForms445_FormLayout {
			...
			/**
			 * @param Wbcr_FactoryForms445_Control $control
			 */
