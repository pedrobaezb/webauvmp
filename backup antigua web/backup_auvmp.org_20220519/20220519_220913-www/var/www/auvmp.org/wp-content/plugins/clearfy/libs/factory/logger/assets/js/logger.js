function wbcr_factory_logger_113_LogCleanup(element) {
    ...
    jQuery.ajax({
        ...
        method: 'post',
        data: {
            action: 'wbcr_factory_logger_113_logs_cleanup',
            nonce: wbcr_factory_logger_113.clean_logs_nonce
        },
        success: function (data) {
            ...
            jQuery.wbcr_factory_clearfy_240.app.showNotice(data.message, data.type);
        },
        error: function (jqXHR, textStatus, errorThrown) {
            jQuery.wbcr_factory_clearfy_240.app.showNotice('Error: ' + errorThrown + ', status: ' + textStatus, 'danger');
            btn.html(currentBtnText);
        }
    });
}
