<?php
	...
	if( !class_exists('Wbcr_FactoryForms445_FormElement') ) {
		 ...
		 * @since 1.0.0
		 */
		abstract class Wbcr_FactoryForms445_FormElement {
			 ...
			 *
			 * @since 1.0.0
			 * @var Wbcr_FactoryForms445_HtmlAttributeBuilder
			 */
			...
			public function __construct($options, $form)
			{
				...
				$this->html_builder = new Wbcr_FactoryForms445_HtmlAttributeBuilder();
