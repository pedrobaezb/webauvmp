<?php
	...
	if( !class_exists('Wbcr_FactoryForms445_OptionsValueProvider') ) {
		 ...
		 * @since 1.0.0
		 */
		class Wbcr_FactoryForms445_OptionsValueProvider implements Wbcr_IFactoryForms445_ValueProvider {
