...
define('H5AP_PLUGIN_VERSION','1.4.1' );
...
function h5ap_style_and_scripts() {
    ...
    wp_enqueue_script( 'h5ap-script', plugin_dir_url( __FILE__ ) . 'js/plyr.min.js' , array(), H5AP_PLUGIN_VERSION , false );
...
?>
<?php ob_start(); ?>
<div style="<?php if(empty(get_post_meta($id,'_ahp_audio-size', true))){echo "width:100%";}else {echo get_post_meta( $id, '_ahp_audio-size', true ) . '; display: inline-block;';};?>">
...
function callback( ) {
	echo'<a target="_blank" href="https://bit.ly/381Ridh"><img width="100%" src="'.H5AP_PLUGIN_DIR.'/img/customization.png" ></a>';
